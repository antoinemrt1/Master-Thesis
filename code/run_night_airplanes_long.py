...
if __name__ == "__main__":
    ...
    # On force les parametres pour la nuit :
    # 10 Missions, Budget de 30 min, 3 Runs statistiques pour que les courbes soient lisses
    run_multiple_experiments(
        strategy=args.strategy,
        budget=30,           # 30 minutes
        missions=10,         # 10 missions successives !
        num_runs=3,          
        imgsz=1024,
        device=args.device
    )